...
namespace AForge.Imaging
{
    ...
    public class UnmanagedImage : IDisposable
    {
        ...
        public UnmanagedImage Clone()
        {
            ...
            AForgeService.SystemTools.CopyUnmanagedMemory(newImageData, imageData, stride * height);
        ...
        public void Copy(UnmanagedImage destImage)
        {
            ...
            {
                // copy entire image
                AForgeService.SystemTools.CopyUnmanagedMemory(destImage.imageData, imageData, stride * height);
            }
            else
            {
                unsafe
                {
                    ...
                    {
                        AForgeService.SystemTools.CopyUnmanagedMemory(dst, src, copyLength);
        ...
        public static UnmanagedImage Create(int width, int height, PixelFormat pixelFormat)
        {
            ...
            AForgeService.SystemTools.SetUnmanagedMemory(imageData, 0, stride * height);
                ...
                else
                {
                    ...
                    unsafe
                    {
                        ...
                        if (stride != dstStride)
                        {
                            ...
                            {
                                AForgeService.SystemTools.CopyUnmanagedMemory(dst, src, lineSize);
                                dst += dstStride;
                                src += stride;
                            }
                        }
                        ...
                        {
                            AForgeService.SystemTools.CopyUnmanagedMemory(dst, src, stride * height);
                        }
                    }
        ...
        public static UnmanagedImage FromManagedImage(BitmapData imageData)
        {
            ...
            AForgeService.SystemTools.CopyUnmanagedMemory(dstImageData, imageData.Scan0, imageData.Stride * imageData.Height);
            image.mustBeDisposed = true;
            ...
            unsafe
            {
                ...
                else
                {
                    ...
                    foreach (IntPoint point in points)
                    {
                        ...
                        pixelValues[i++] = ptr[AForgeService.RGB.R];
                        pixelValues[i++] = ptr[AForgeService.RGB.G];
                        pixelValues[i++] = ptr[AForgeService.RGB.B];
                    }
                }
            }
                ...
                if ((pixelFormat == PixelFormat.Format16bppGrayScale) || (pixelSize > 4))
                {
                    ...
                    for (int y = startY; y < stopY; y++)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                if ((ptr[AForgeService.RGB.R] != 0) || (ptr[AForgeService.RGB.G] != 0) || (ptr[AForgeService.RGB.B] != 0))
                                {
                                    pixels.Add(new IntPoint(x, y));
                                }
                            }
                    ...
                    case PixelFormat.Format32bppRgb:
                        {
                            ...
                            foreach (IntPoint point in coordinates)
                            {
                                if ((point.X >= 0) && (point.Y >= 0) && (point.X < width) && (point.Y < height))
                                {
                                    ...
                                    ptr[AForgeService.RGB.R] = red;
                                    ptr[AForgeService.RGB.G] = green;
                                    ptr[AForgeService.RGB.B] = blue;
                                }
                            }
                        }
                        break;
                    ...
                    case PixelFormat.Format48bppRgb:
                        {
                            ...
                            foreach (IntPoint point in coordinates)
                            {
                                if ((point.X >= 0) && (point.Y >= 0) && (point.X < width) && (point.Y < height))
                                {
                                    ...
                                    ptr[AForgeService.RGB.R] = red16;
                                    ptr[AForgeService.RGB.G] = green16;
                                    ptr[AForgeService.RGB.B] = blue16;
                                }
                            }
                        }
                        break;
                    ...
                    case PixelFormat.Format64bppArgb:
                        {
                            ...
                            foreach (IntPoint point in coordinates)
                            {
                                if ((point.X >= 0) && (point.Y >= 0) && (point.X < width) && (point.Y < height))
                                {
                                    ...
                                    ptr[AForgeService.RGB.G] = green16;
                                    ptr[AForgeService.RGB.B] = blue16;
                                    ptr[AForgeService.RGB.A] = alpha16;
                                }
                            }
                        }
                        break;
            ...
            if ((x >= 0) && (y >= 0) && (x < width) && (y < height))
            {
                unsafe
                {
                    ...
                    switch (pixelFormat)
                    {
                        ...
                        case PixelFormat.Format24bppRgb:
                        case PixelFormat.Format32bppRgb:
                            ptr[AForgeService.RGB.R] = r;
                            ptr[AForgeService.RGB.G] = g;
                            ptr[AForgeService.RGB.B] = b;
                            break;
                        ...
                        case PixelFormat.Format48bppRgb:
                            ptr2[AForgeService.RGB.R] = (ushort)(r << 8);
                            ptr2[AForgeService.RGB.G] = (ushort)(g << 8);
                            ptr2[AForgeService.RGB.B] = (ushort)(b << 8);
                            break;
                        ...
                        case PixelFormat.Format64bppArgb:
                            ...
                            ptr2[AForgeService.RGB.G] = (ushort)(g << 8);
                            ptr2[AForgeService.RGB.B] = (ushort)(b << 8);
                            ptr2[AForgeService.RGB.A] = (ushort)(a << 8);
                            break;
        ...
        public Color GetPixel(int x, int y)
        {
            ...
            unsafe
            {
                ...
                switch (pixelFormat)
                {
                    ...
                    case PixelFormat.Format24bppRgb:
                    case PixelFormat.Format32bppRgb:
                        color = Color.FromArgb(ptr[AForgeService.RGB.R], ptr[AForgeService.RGB.G], ptr[AForgeService.RGB.B]);
                        break;

                    case PixelFormat.Format32bppArgb:
                        color = Color.FromArgb(ptr[AForgeService.RGB.A], ptr[AForgeService.RGB.R], ptr[AForgeService.RGB.G], ptr[AForgeService.RGB.B]);
                        break;
